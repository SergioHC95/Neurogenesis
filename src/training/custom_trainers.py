...
class ProfilingDiagnosticsLoggingTrainer(ProfilingTrainer, DiagnosticsTrainer, LoggingTrainer):
    """
...
class NotebookFullFeaturedTrainer(NotebookTrainer, ProfilingTrainer, DiagnosticsTrainer, LoggingTrainer):
    """
